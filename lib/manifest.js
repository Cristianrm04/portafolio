...
(function () {
  ...
  window.__BRAND__ = {
    ...
    heroKicker: "Desarrollador Full Stack · Cali, Colombia",
    heroSub:
    ...
    cases: [
      {
        id: "rethus",
        tag: "Proyecto principal — sector público",
      ...
      // Iptotal/Celsia case retired from the site for now (Cristian wants only
      // RETHUS shown as "proyecto principal" until he adds more finished projects).
    ],
